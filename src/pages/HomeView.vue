...
<template>
  <div class="flex flex-col gap-12">
    ...
    <div class="flex flex-col md:flex-row gap-4 h-[400px] md:h-[480px]">
      <div
        class="flex-1 bg-white shadow-md rounded-xl flex flex-col justify-evenly"
      >
        <div class="p-10 font-semibold sm:text-[60px] text-[30px]">
      ...
      <Transition
        mode="out-in"
        class="flex-1 bg-text-dark shadow-md rounded-xl w-[40vw]"
      >
